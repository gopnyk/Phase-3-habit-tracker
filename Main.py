...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    def habits_statistics(self):
        ...
        overview_label = CTkLabel(self.frame_1_statistics, text ="Statistics:",
        ...
        total_missed, total_completed = self.hc.totals_sorted("Lifetime", "All", self.shown_date)
        consistency = 0
        if total_missed+ total_completed == 0:
            consistency = 0
        else:
            consistency = total_completed/ (total_missed+total_completed) * 100
        ...
        total_habits_2_label = CTkLabel(self.frame_1_statistics, text=f"{self.hc.count_habits()}",
                                  font=CTkFont(family="arial", weight="bold", size=14), text_color="black")

        total_completions_2_label =CTkLabel(self.frame_1_statistics, text=f"{total_completed}",
                                  font=CTkFont(family="arial", weight="bold", size=14), text_color="black")

        missed_2_label = CTkLabel(self.frame_1_statistics, text=f"{total_missed}",
                                  font=CTkFont(family="arial", weight="bold", size=14), text_color="black")

        consistency_2_label= CTkLabel(self.frame_1_statistics, text=f"{round(consistency,1)}%",
                                  font=CTkFont(family="arial", weight="bold", size=14), text_color="black")
        ...
        def update_header():
            ...
            missed, completed = self.hc.totals_sorted(date_format, habit_type_filter.get(),self.shown_date)
